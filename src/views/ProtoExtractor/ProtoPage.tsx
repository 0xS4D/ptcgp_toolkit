        ...
        <CardContent className="flex flex-col gap-3">
          ...
          <div>
            <Label className="mb-1 text-xs">
              Blacklist (comma-separated prefixes to exclude)
            </Label>
            <Input
              value={blacklistText}
            ...
            <p className="mt-1 text-xs text-muted-foreground">
              Namespaces starting with these prefixes will be excluded from
              generation
            </p>
          </div>
          ...
          <Button
            ...
            disabled={
              isGenerating || !libil2cppPath || !metadataPath || !protosPath
            }
            size="sm"
            className="text-xs"
          >
